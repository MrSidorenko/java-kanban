...
public class TaskManager {
    ...
    // ниже представлены все методы для работы Epic
    ...
    public void updateEpic(Epic updatedEpic) {
        ...
        newEpic.setStatus(updatedEpic.getStatus()); // Устанавливаем новый статус
    ...
    public void removeEpic(int epicId) {
        ...
        if (epic != null) {
            ...
            for (Integer subtaskId : subtaskIds) {
                removeSubtask(subtaskId);  // Используем метод removeSubtask для каждой подзадачи
            }
        }
    }
    // - 4
